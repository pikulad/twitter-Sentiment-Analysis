# Made with 💖 by Priyank lad (https://www.github.com/pikulad)
#
...
shinyServer(function(input, output, session) {
  consumer_api_key <- "7hF28Nqod0wBGdozDtPQ4Cynm"                                         # Enter your consumer key
  consumer_api_secret <- "sa9IQEUtFs8dth6E9eCkhbU73ieQCCwpeo2NUf4PMJUo1M9e8H"             # Enter your consumer secret
  access_token <- "4076488872-S6c8QzvHkOMZvAgvD5A54vSLPrtquvYiPFCBgXw"                    # Enter your access token
  access_token_secret <- "sZRHlbqpCBO9acxfwQEqypa49DSsZ49Pxn1PZDDa3ctcu"                  # Enter your access secret
